...
/**
 * Servlet implementation class PboardMyUnLikeList
 */
@WebServlet("/pboardMyUnLikeList.do")
public class PboardMyUnLikeList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<PboardVO> list = service.selectMyUnLike(memId, more);
